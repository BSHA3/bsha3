...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BSHA3 address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BSHA3 addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BSHA3 addresses"));
...
{
    QString strTitle = tr("BSHA3"); // default title
