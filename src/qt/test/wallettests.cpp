...
//
//     src/qt/test/test_bsha3-qt -platform xcb      # Linux
//     src/qt/test/test_bsha3-qt -platform windows  # Windows
//     src/qt/test/test_bsha3-qt -platform cocoa    # macOS
void TestGUI()
{
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'test_bsha3-qt -platform cocoa' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI();
