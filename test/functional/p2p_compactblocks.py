...
# TestP2PConn: A peer we use to send messages to bsha3d, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes bsha3d to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bsha3d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bsha3d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bsha3d will not send blocktxn responses for blocks whose height is
