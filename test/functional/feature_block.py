...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bsha3d isn't accepting b26
        ...
        # Extend the b28 chain to make sure bsha3d isn't accepting b28
        ...
        # bsha3d doesn't disconnect us for sending a bloated block, but if we subsequently
