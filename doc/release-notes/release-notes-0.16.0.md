...
Testing changes
----------------
- The default regtest JSON-RPC port has been changed to 18443 to avoid conflict with testnet's default of 18334.
...
- #10825 `28485c7` Set regtest JSON-RPC port to 18443 to avoid conflict with testnet 18334 (fametrano)
...
- #10529 `331352f` Improve bsha3d systemd service file (Flowdalic)
