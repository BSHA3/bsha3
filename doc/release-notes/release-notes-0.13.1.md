...
- #8829 `2a8bca4` Add bsha3-tx JSON tests (jnewbery)
...
- #8860 `0bee740` util: Move wait_bsha3ds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update bsha3-tx to output witness data (jnewbery)
