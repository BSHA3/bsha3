...
* Universal Plug and Play support.  Enable automatic opening of a port for incoming connections by running bitcoin or bsha3d with the - -upnp=1 command line switch or using the Options dialog box.
...
* Several bug fixes, including a serious intermittent bug that would sometimes cause bsha3d to stop accepting rpc requests. 
