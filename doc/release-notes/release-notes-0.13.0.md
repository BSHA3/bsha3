...
- #7613 `3798e5d` Add autocomplete to bsha3-qt's console window (GamerSg)
...
- #8256 `af2421c` BUG: bsha3-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from bsha3d (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for bsha3d procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of bsha3d startup (laanwj)
