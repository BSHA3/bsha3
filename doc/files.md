...
* bitcoin.conf: contains configuration settings for bsha3d or bitcoin-qt
* bsha3d.pid: stores the process id of bsha3d while running
...
* debug.log: contains debug information and general logging generated by bsha3d or bitcoin-qt
